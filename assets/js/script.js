...
function fetchWeather(location) {
  ...
  var apiUrl = `${weatherMainURL}/data/2.5/forecast?lat=${lat}&lon=${lon}&units=imperial&appid=${weatherApiKey}`;
...
function GetCoordinates(search) {
  var apiUrl = `${weatherMainURL}/geo/1.0/direct?q=${search}&limit=5&appid=${weatherApiKey}`;
...
initSearchHistory();
CitySearch.addEventListener('submit', handleCitySearchSubmit);
